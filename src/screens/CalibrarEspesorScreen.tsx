...
type Props = StackScreenProps<RootStackParamList, 'CalibrarEspesorScreen'>;

const CalibrarEspesorScreen: React.FC<Props> = ({ route }) => {
    ...
    const guardarConEstado = async (estatusFinal: string) => {
        ...
        try {
            const response = await fetch('http://192.168.16.146:3002/api/calibraciones/calibracionEspesor', {
                method: 'POST',
                ...
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    <View style={styles.topContainer}>
                        ...
                        <View style={styles.equipoRow}>
                            ...
                            <Image source={require('./assets/espesor.png')} style={styles.equipoIcon} resizeMode="contain" />
                        </View>
                                ...
                                index === 6 ? (
                                    <View key={index} style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', marginBottom: 10 }}>
                                        ...
                                        <View style={{ width: '48%' }}>
                                            ...
                                            <Text style={styles.inputPatron}>{'I-CAL-006'}</Text>
                                        </View>
                                    </View>
                                ) : (
...
export default CalibrarEspesorScreen;